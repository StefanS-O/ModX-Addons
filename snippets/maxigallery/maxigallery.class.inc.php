...
class maxiGallery {
	...
	function regScriptsAndCSS(){
		...
		//slimbox2 scripts
		$slimbox2_css_link = '<link rel="stylesheet" href="' . $modx->config['base_url'] . MAXIGALLERY_PATH . 'slimbox2/css/slimbox2.css" type="text/css" media="screen" />';
		$slimbox2_script_link1 = $modx->config['base_url'] . MAXIGALLERY_PATH . 'slimbox2/js/slimbox2.js'; 
		...
		//register slimbox2 scripts if in use
		if(($this->mgconfig['display'] == "embedded" && $this->mgconfig['embedtype'] == "slimbox2") || ($this->mgconfig['keep_bigimg'] && $this->mgconfig['big_img_linkstyle'] == "slimbox2")){
			$modx->regClientCSS($slimbox2_css_link);
			$modx->regClientStartupScript($slimbox2_script_link1);
		}
